...
/**
 * DAOs page — every DAO defined in daos.ts. Enabled DAOs link to their
 * proposals ("/proposals/<dao>"); disabled DAOs are listed but greyed out
 * and not clickable. NOTE: the disabled gate is client-side only for now —
 * the future backend must also refuse writes for disabled DAOs.
 */
